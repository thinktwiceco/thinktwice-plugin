# ThinkTwice Style Guide

A guide to the visual identity, emotional tone, and design philosophy that shapes how users experience ThinkTwice.

---

## The Concept

ThinkTwice exists in the space between impulse and intention. It's not a blocker or a barrier—it's a gentle pause button in a world of instant gratification.

### Core Philosophy

**Thoughtful Consumption Over Impulse Buying**

ThinkTwice intervenes at the moment of purchase, not to stop you, but to give you space. The design reflects this philosophy:

- **Non-judgmental**: We don't shame or block. We invite reflection.
- **Supportive**: Like a trusted friend asking "Are you sure?" not a parent saying "No."
- **Empowering**: You remain in control. We just help you think clearly.
- **Calm**: In a world of bright "Buy Now" buttons, we offer a moment of quiet consideration.

### The User Experience Feeling

When users interact with ThinkTwice, they should feel:

1. **Relieved** - "Finally, something that helps me pause instead of pushing me to buy"
2. **Empowered** - "I'm making a conscious choice, not being manipulated"
3. **Calm** - "This feels peaceful, not stressful"
4. **Trusted** - "This tool respects my autonomy and privacy"
...
## Color Palette & Emotional Meaning
...
- **Sophistication** - Mature and thoughtful, not flashy

These colors create a **calm container** that feels separate from the bright, urgent Amazon page. It's a visual "breathing room" that signals: "This is a different kind of space—one for thinking, not buying."

### The Primary Action: Mint Green
...
- **Hope** - The possibility of making better choices
...
### The Secondary Action: Soft Blue
...
- **Peace** - A gentle, reassuring presence
...
### The Tertiary Action: Soft Coral
...
- **Strength** - The courage to make different choices
...
### The Popup Interface: Clean & Neutral
...
- **Neutral** - Doesn't compete with the main overlay's emotional tone

This is the "settings" space—functional, clear, and straightforward.
...
2. **Gentle, Not Aggressive**
   - Soft colors, not bright or urgent
   - Rounded corners, not sharp edges
   - Smooth animations, not jarring transitions

3. **Invitation, Not Demand**
   - Buttons feel clickable but not pushy
   - Text is friendly, not commanding
   - Options are presented, not forced

4. **Trust Through Transparency**
   - Clear, honest language
   - Privacy badges and explanations
   - No hidden agendas
...
When a user encounters ThinkTwice, the visual language should tell this story:

1. **"This is different"** - The dark, calm overlay stands apart from the bright Amazon page
2. **"This is safe"** - Soft colors and gentle interactions feel non-threatening
3. **"You're in control"** - Clear options, no pressure, your choice
...
To maintain clarity, this style explicitly avoids:

- ❌ **Bright, urgent colors** (reds, oranges for primary actions)
- ❌ **Aggressive language** ("STOP!" "DON'T BUY!")
- ❌ **Corporate or salesy aesthetics**
- ❌ **Cluttered or overwhelming layouts**
- ❌ **Judgmental or preachy tone**
- ❌ **Dark patterns** (fake urgency, scarcity tactics)
- ❌ **Overly playful or childish** (we respect the user's intelligence)

---

## The Goal

Every design decision should answer: **"Does this help the user feel calm, empowered, and thoughtful?"**

If the answer is yes, it fits the ThinkTwice style.

If the answer is no—if it feels urgent, pushy, judgmental, or manipulative—it doesn't belong.
