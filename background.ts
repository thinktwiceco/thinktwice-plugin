...
if (chromeAPI.alarms) {
  ...
  console.error(
    "[Background] ❌ Cannot register alarm listener - chrome.alarms is undefined"
  )
}
...
if (chromeAPI.notifications) {
  ...
  console.error(
    "[Background] ❌ Cannot register notification listener - chrome.notifications is undefined"
  )
}
